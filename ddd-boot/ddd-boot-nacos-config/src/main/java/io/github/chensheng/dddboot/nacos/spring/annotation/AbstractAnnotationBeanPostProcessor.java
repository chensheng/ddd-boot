...
import static io.github.chensheng.dddboot.nacos.spring.util.AnnotationUtils.getAnnotationAttributes;
...
public abstract class AbstractAnnotationBeanPostProcessor extends
    ...
    private List<AbstractAnnotationBeanPostProcessor.AnnotatedFieldElement> findFieldAnnotationMetadata(final Class<?> beanClass) {
        ...
        final List<AbstractAnnotationBeanPostProcessor.AnnotatedFieldElement> elements = new LinkedList<AnnotatedFieldElement>();
