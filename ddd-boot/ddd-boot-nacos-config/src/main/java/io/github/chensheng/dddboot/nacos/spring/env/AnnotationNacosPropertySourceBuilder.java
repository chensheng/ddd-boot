...
import io.github.chensheng.dddboot.nacos.spring.context.annotation.config.NacosPropertySources;
...
public class AnnotationNacosPropertySourceBuilder
	...
	private List<Map<String, Object>> getAnnotationAttributesList(
		...
		else if (NacosPropertySource.class
	...
	private void initAutoRefreshed(NacosPropertySource nacosPropertySource,
		...
		boolean autoRefreshed = Boolean.TRUE
				.equals(annotationAttributes.get(io.github.chensheng.dddboot.nacos.spring.context.annotation.config.NacosPropertySource.AUTO_REFRESHED_ATTRIBUTE_NAME));
	...
	private void initOrder(NacosPropertySource nacosPropertySource,
		...
		boolean first = Boolean.TRUE
				.equals(annotationAttributes.get(io.github.chensheng.dddboot.nacos.spring.context.annotation.config.NacosPropertySource.FIRST_ATTRIBUTE_NAME));
		String before = (String) annotationAttributes.get(io.github.chensheng.dddboot.nacos.spring.context.annotation.config.NacosPropertySource.BEFORE_ATTRIBUTE_NAME);
		String after = (String) annotationAttributes.get(io.github.chensheng.dddboot.nacos.spring.context.annotation.config.NacosPropertySource.AFTER_ATTRIBUTE_NAME);
