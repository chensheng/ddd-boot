...
import io.github.chensheng.dddboot.nacos.spring.annotation.AnnotationNacosInjectedBeanPostProcessor;
import io.github.chensheng.dddboot.nacos.spring.annotation.ConfigServiceBeanBuilder;
import io.github.chensheng.dddboot.nacos.spring.annotation.NamingMaintainServiceBeanBuilder;
import io.github.chensheng.dddboot.nacos.spring.annotation.NamingServiceBeanBuilder;
import io.github.chensheng.dddboot.nacos.spring.context.annotation.config.NacosConfigListenerMethodProcessor;
import io.github.chensheng.dddboot.nacos.spring.context.annotation.config.NacosValueAnnotationBeanPostProcessor;
import io.github.chensheng.dddboot.nacos.spring.context.event.LoggingNacosConfigMetadataEventListener;
import io.github.chensheng.dddboot.nacos.spring.context.properties.config.NacosConfigurationPropertiesBindingPostProcessor;
import io.github.chensheng.dddboot.nacos.spring.env.AnnotationNacosPropertySourceBuilder;
import io.github.chensheng.dddboot.nacos.spring.env.NacosPropertySourcePostProcessor;
import io.github.chensheng.dddboot.nacos.spring.env.XmlNacosPropertySourceBuilder;
import io.github.chensheng.dddboot.nacos.spring.factory.ApplicationContextHolder;
...
import io.github.chensheng.dddboot.nacos.spring.context.constants.NacosConstants;
...
import static io.github.chensheng.dddboot.nacos.spring.util.NacosUtils.resolveProperties;
...
public abstract class NacosBeanUtils {
	...
	private static int getParallelism(Environment environment) {
		int parallelism = environment.getProperty(NacosConstants.NACOS_CONFIG_LISTENER_PARALLELISM,
				int.class, NacosConstants.DEFAULT_NACOS_CONFIG_LISTENER_PARALLELISM);
